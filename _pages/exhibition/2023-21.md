...
<a href="/exhibition#21" class="back-to-top text-left" style="margin-top: 20px;"><i class="fas fa-chevron-circle-left"></i>作品一覧に戻る</a>
</div>
<!-- ↓ここの数字は作品が増えた場合に変更する。 -->
{% if 21==30 %}
<div class="article-navigation" style="margin-bottom: 100px;">
    <a href="/expo/20" class="previous-article">&lt; 前の記事へ</a>
    &nbsp;・&nbsp; <!-- 中間の・ -->
...
<!-- ↓ここの数字は作品が増えた場合に変更する。 -->
  ...
  &nbsp;・&nbsp; <!-- 中間の・ -->
  <a href="/expo/22" class="next-article">次の記事へ &gt;</a>
</div>
{%else%}
<div class="article-navigation" style="margin-bottom: 100px;">
  <a href="/expo/20" class="previous-article">&lt; 前の記事へ</a>
