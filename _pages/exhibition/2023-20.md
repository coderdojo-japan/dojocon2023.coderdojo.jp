...
<div class="main_content">
  ...
  <p>
    作者: ゆうと
    <small>(CoderDojo <a href='https://www.coderdojo-nishio.com/'>西尾</a>, <a href='https://coderdojoowari.org/'>尾張</a>)</small>
  </p>
...
<div>
  <a href="https://scratch.mit.edu/projects/873338220/" target="_blank" rel="noopener" class="button">
    <i class="fas fa-scroll"></i>
    作品を見る
  </a>
  <a href="https://twitter.com/intent/tweet?text={{ page.title | replace: '&', '%26' }}+%7C+ニンジャ大博覧会&hashtags=DojoConJapan,CoderDojo&url={{ site.url }}/expo/20&lang=jp&related=DojoConJapan" target="_blank" rel="noopener" class="button" style="margin: 50px auto;">
    <i class="fab fa-twitter"></i>
    作品を共有する
  </a>
  <a href="https://www.facebook.com/share.php?u={{ site.url }}/expo/20" target="_blank" rel="noopener" class="button">
...
<div class="article-navigation" style="margin-bottom: 100px;">
  <a href="/expo/19" title="名古屋駅シュミレーター" style="margin-right: 20px;">
    <i class="fas fa-arrow-left"></i>
    前の作品へ<br>
    <span style="font-size: 8px;">名古屋駅シュミレーター...</span>
  </a>
  <a href="/expo/21" title="世界一難しいゲームを再現しました" style="margin-left: 20px;">
    次の作品へ
