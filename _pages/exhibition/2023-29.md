...
permalink: /expo/29
description: 『かんづめ食堂』のウェブサイトを作りました。缶詰や非常食を使ったレシピを公開していくウェブサイトです。
---
...
<div class="main_content">
  ...
  <div class="contents">
    <div class="box">
      <h5>作品の説明</h5>
      <p>『かんづめ食堂』のウェブサイトを作りました。缶詰や非常食を使ったレシピを公開していくウェブサイトです。</p>
    </div>
...
<div class="article-navigation" style="margin-bottom: 100px;">
    <a href="/expo/28" class="previous-article">&lt; 前の記事へ</a>
    &nbsp;・&nbsp; <!-- 中間の・ -->
...
<!-- ↓ここの数字は作品が増えた場合に変更する。 -->
  ...
  &nbsp;・&nbsp; <!-- 中間の・ -->
  <a href="/expo/30" class="next-article">次の記事へ &gt;</a>
</div>
{%else%}
<div class="article-navigation" style="margin-bottom: 100px;">
  <a href="/expo/28" class="previous-article">&lt; 前の記事へ</a>
