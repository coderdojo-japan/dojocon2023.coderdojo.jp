...
<a href="/exhibition#22" class="back-to-top text-left" style="margin-top: 20px;"><i class="fas fa-chevron-circle-left"></i>作品一覧に戻る</a>
</div>
<!-- ↓ここの数字は作品が増えた場合に変更する。 -->
{% if 22==30 %}
<div class="article-navigation" style="margin-bottom: 100px;">
    <a href="/expo/21" class="previous-article">&lt; 前の作品へ</a>
    &nbsp;・&nbsp; <!-- 中間の・ -->
...
<!-- ↓ここの数字は作品が増えた場合に変更する。 -->
  ...
  &nbsp;・&nbsp; <!-- 中間の・ -->
  <a href="/expo/23" class="next-article">次の作品へ &gt;</a>
</div>
{%else%}
<div class="article-navigation" style="margin-bottom: 100px;">
  <a href="/expo/21" class="previous-article">&lt; 前の作品へ</a>
