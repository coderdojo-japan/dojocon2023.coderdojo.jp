...
<div style='margin-bottom: 100px;'>
  ...
  <a href="https://twitter.com/intent/tweet?text={{ page.title | replace: '&', '%26' }}+%7C+ニンジャ大博覧会&hashtags=DojoConJapan,CoderDojo&url={{ site.url }}/expo/19&lang=jp&related=DojoConJapan" target="_blank" rel="noopener" class="button air">
