...
<a href="/exhibition#33" class="back-to-top text-left" style="margin-top: 20px;"><i class="fas fa-chevron-circle-left"></i>作品一覧に戻る</a>
</div>
<!-- ↓ここの数字は作品が増えた場合に変更する。 -->
{% if 33==33 %}
...
<!-- ↓ここの数字は作品が増えた場合に変更する。 -->
  ...
  &nbsp;・&nbsp; <!-- 中間の・ -->
  <a href="/expo/34" class="next-article">次の作品へ &gt;</a>
</div>
{%else%}
<div class="article-navigation" style="margin-bottom: 100px;">
  <a href="/expo/32" class="previous-article">&lt; 前の作品へ</a>
